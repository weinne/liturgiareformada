...
export const hymnSuggestions = {
  worshipCall: [
    'Novo Cântico 14 - Louvor',
    'Novo Cântico 42 - Cântico ao Cordeiro',
    'Novo Cântico 52 - Glória e Majestade',
    'Salmo 8 - Ó Senhor, quão maravilhoso',
    'Salmo 100 - Cantai alegres ao Senhor',
  ],
  lawReading: [
    'Novo Cântico 33 - A Lei do Senhor',
    'Novo Cântico 111 - Maravilhosa Graça',
    'Salmo 19 - Os céus proclamam',
    'Salmo 119 - Lâmpada para os meus pés',
  ],
  forgiveness: [
    'Novo Cântico 62 - Coração Quebrantado',
    'Novo Cântico 136 - Perdão',
    'Novo Cântico 224 - Segurança e Alegria',
    'Salmo 32 - Bem-aventurado',
    'Salmo 51 - Tem misericórdia de mim',
  ],
  intercession: [
    'Novo Cântico 87 - Intercessão',
    'Novo Cântico 129 - Súplica ao Senhor',
    'Salmo 20 - O Senhor te ouça',
    'Salmo 130 - Das profundezas',
  ],
  illumination: [
    'Novo Cântico 105 - A Revelação de Deus',
    'Novo Cântico 172 - Instrui-me, ó Senhor',
    'Salmo 19 - A lei do Senhor é perfeita',
    'Salmo 119 - Como o jovem manterá puro o seu caminho',
  ],
  wordPreaching: [
    'Novo Cântico 81 - O Evangelho',
    'Novo Cântico 177 - A Palavra Viva',
    'Novo Cântico 197 - Cristo, o Verbo',
    'Salmo 119 - Quanto amo a tua lei',
  ],
  lordsSupper: [
    'Novo Cântico 98 - Ceia do Senhor',
    'Novo Cântico 147 - Comunhão',
    'Novo Cântico 190 - Memorial',
    'Salmo 116 - Que darei ao Senhor',
  ],
  consecration: [
    'Novo Cântico 119 - Consagração',
    'Novo Cântico 176 - Oferta de Amor',
    'Novo Cântico 207 - Gratidão',
    'Salmo 116 - Que darei ao Senhor',
  ],
  sending: [
    'Novo Cântico 170 - Comissão',
    'Novo Cântico 208 - Ide',
    'Novo Cântico 235 - Servos do Senhor',
    'Salmo 67 - Deus tenha misericórdia',
  ],
  blessing: [
    'Novo Cântico 150 - Bênção Apostólica',
    'Novo Cântico 180 - Despedida',
    'Novo Cântico 225 - A Bênção do Senhor',
